...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 18, 2026 at 04:33 AM
...
(00000003, 'มานาว', 'ต่างดุ๊ด👽', '067676767', 'manao', '1234');
...
INSERT INTO `employees` (`emp_id`, `firstName`, `lastName`, `phone`, `username`, `password`) VALUES
(00000001, 'Somchai', 'Wongdee', '0812345678', 'somchaiw', 'password123'),
(00000002, 'Anong', 'Srisuk', '0898765432', 'anongs', 'securepass456');
...
(1, 'เสื้อยืดคอกลม', 'เสื้อยืดผ้าฝ้าย 100% สวมใส่สบาย', '199.00', 'tshirt.jpg', 50, '2026-09-04 02:45:58'),
(2, 'กางเกงยีนส์', 'กางเกงยีนส์ทรงกระบอก สีฟ้าอ่อน', '799.00', 'jeans.jpg', 30, '2026-09-04 02:45:58'),
(3, 'รองเท้าผ้าใบ', 'รองเท้าผ้าใบสีขาว ใส่ได้ทุกโอกาส', '1299.00', 'sneakers.jpg', 20, '2026-09-04 02:45:58');
